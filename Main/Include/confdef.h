...
#define DEAD_GRASS (SOLID_ID + 74)
#define KAURI_WOOD (SOLID_ID + 75)
#define RATA_WOOD (SOLID_ID + 76)
#define NEPHRITE (SOLID_ID + 77)
#define HESSIAN_CLOTH (SOLID_ID + 78)
...
#define MANGO_FLESH (ORGANIC_ID + 15)
#define HOLY_MANGO_FLESH (ORGANIC_ID + 16)
...
#define LIQUID_HORROR (LIQUID_ID + 27)
#define VINEGAR (LIQUID_ID + 28)
#define OMMEL_BLOOD (LIQUID_ID + 29)
#define CURDLED_OMMEL_BLOOD (LIQUID_ID + 30)
...
#define MUTANT_HEDGEHOG_FLESH (FLESH_ID + 46)
#define EAGLE_FLESH (FLESH_ID + 47)
#define KABOUTER_FLESH (FLESH_ID + 48)
#define ULDRA_FLESH (FLESH_ID + 49)
#define OKAPI_FLESH (FLESH_ID + 50)
#define VAMPIRE_FLESH (FLESH_ID + 51)
#define MOUSE_FLESH (FLESH_ID + 52)
#define FOX_FLESH (FLESH_ID + 53)
#define THUNDER_BIRD_FLESH (FLESH_ID + 54)
