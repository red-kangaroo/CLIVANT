...
const char* dragontower::GetNameStem() const { return "ruined tower"; }
v2 dragontower::GetBitmapPos(int) const { return v2(50, 80); }
int dragontower::GetAttachedDungeon() const { return DRAGON_TOWER; }

const char* darkforest::GetNameStem() const { return "dark forest"; }
...
cchar* xinrochtomb::GetNameStem() const
{ return "tomb of utter darkness where dwells the soul of Xinroch"; }
